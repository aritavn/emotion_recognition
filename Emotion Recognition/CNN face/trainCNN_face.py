...
# --- Data ---
faces_fer, emotions_fer = utils.load_FER2013()
faces_fabo, emotions_fabo = utils.load_FABO()

faces = np.vstack((faces_fer, faces_fabo))
emotions = np.vstack((emotions_fer, emotions_fabo))

faces = utils.preprocess_input(faces)

# Divide data into train and validation subsets
faces_train, faces_val, emotions_train, emotions_val = train_test_split(
...
hist = model.fit_generator(data_generator.flow(faces_train, emotions_train, batch_size),
